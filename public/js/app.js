...
function updateAuthUI() {
    ...
    const btnLoginMs   = document.getElementById("btn-seguinte") || document.getElementById("btn-login-ms");

    // Sempre fecha o loading overlay ao mudar de estado
    ...
    if (!AuthState.isAuthorized) {
        ...
        // Botão de sair na tela de bloqueio
